...
export default function ContractManufacturing() {
  const steps = [
    { num: '01', code: 'STEP-BRF-01', title: 'Product Brief & Target Formula', desc: 'Define active botanical markers, delivery platform (softgels, gummies, effervescents), target dosage, and regulatory market requirements.' },
    { num: '02', code: 'STEP-FEAS-02', title: 'Phytochemical Feasibility Review', desc: 'Assess ingredient compatibility, solubility parameters, bioavailability enhancers, and thermolabile stability factors.' },
    { num: '03', code: 'STEP-LAB-03', title: 'Laboratory Pilot Batch (1–5 kg)', desc: 'Formulate initial benchtop prototypes, optimize viscosity, moisture binding, and test active ingredient dispersion.' },
    { num: '04', code: 'STEP-MSK-04', title: 'Organoleptic & Taste Masking', desc: 'Advanced flavor engineering to neutralize bitter botanical astringency without synthetic aftertastes or compromising bioactivity.' },
    { num: '05', code: 'STEP-SGN-05', title: 'Client Prototype Sign-Off', desc: 'Physical sample submission for sensory, visual, dissolution, and initial client assay validation.' },
    { num: '06', code: 'STEP-REG-06', title: 'Regulatory Dossier & Compliance', desc: 'Formulation compliance check against FSSAI, AYUSH, or target international export regulatory monographs.' },
    { num: '07', code: 'STEP-SCL-07', title: 'Pilot Commercial Scale-Up', desc: 'Transfer formulation to pilot industrial equipment (50–100 kg) to establish critical process parameters (CPPs).' },
    { num: '08', code: 'STEP-STB-08', title: 'Analytical Assay & Stability Initiation', desc: 'HPLC potency quantification, heavy metals check, and ICH Q1A stability chamber sample placement.' },
    { num: '09', code: 'STEP-CLR-09', title: 'Commercial Cleanroom Run', desc: 'Full batch production execution under automated cGMP cleanroom parameters with in-line IPQC monitoring.' },
    { num: '10', code: 'STEP-REL-10', title: 'QP Quality Release & Dispatch', desc: 'Batch Manufacturing Record (BMR) sign-off, Certificate of Analysis (CoA) generation, and climate-controlled dispatch.' }
  ];
    ...
    <div className="bg-[#F8FAFC] text-[#030914] space-y-32 md:space-y-48 pb-36 font-telegraf">
      ...
      <section id="roadmap" className="max-w-[1800px] mx-auto px-6 md:px-16 scroll-mt-32">
        <div className="flex items-center gap-6 border-b border-slate-300 pb-4 mb-16">
          <span className="monogram-badge">METHODOLOGY ROADMAP // 10 GATES</span>
          <span className="font-architekt text-xs uppercase tracking-widest text-[#0052FF] font-bold">///////////////////////////////////</span>
          <span className="font-architekt text-xs uppercase tracking-widest text-slate-500">[ CRITICAL PATHWAY ]</span>
        </div>
