...
export default function Quality() {
  ...
  const steps = [
    { num: '01', title: 'Botanical Voucher Verification', desc: 'Macroscopic, microscopic, and TLC botanical identity fingerprinting against Ayurvedic Pharmacopoeia (API) reference standards.' },
    { num: '02', title: 'Heavy Metals ICP-MS Screening', desc: 'Trace elemental quantification for Lead (Pb), Cadmium (Cd), Mercury (Hg), and Arsenic (As) adhering strictly to USP <2232> limits.' },
    { num: '03', title: 'Pesticide & Aflatoxin Assay', desc: 'Screening for 100+ organochlorine and organophosphate pesticide residues alongside aflatoxins (B1, B2, G1, G2) and Ochratoxin A.' },
    { num: '04', title: 'Microbiology & Pathogen Testing', desc: 'Total aerobic microbial count (TAMC), total yeast/mold count (TYMC), and absolute absence of E. coli, Salmonella, and S. aureus in Class 10k cleanrooms.' },
    { num: '05', title: 'In-Process Controls (IPQC)', desc: 'Real-time monitoring of granulation moisture loss on drying (LOD), tablet hardness, friability (<1%), disintegration, and softgel ribbon thickness.' },
    { num: '06', title: 'HPLC / HPTLC Active Marker Assay', desc: 'High-performance liquid chromatography quantification of key bioactives (Withanolides ≥5%, Curcuminoids ≥95%, Boswellic acids ≥65%).' },
    { num: '07', title: 'Packaging Seal & Leak Integrity', desc: 'Methylene blue vacuum desiccator leak testing on Alu-Alu blister cavities, induction seal torque testing on HDPE bottles.' },
    { num: '08', title: 'ICH Q1A Stability Protocols', desc: 'Real-time and accelerated stability chambers (40°C ± 2°C / 75% RH ± 5% RH) to establish verifiable shelf-life and degradation kinetics.' },
    { num: '09', title: 'Finished Batch QP Release', desc: 'Comprehensive Batch Manufacturing Record (BMR) reconciliation, CoA generation, and formal release by Quality Assurance.' }
  ];
    ...
    <div className="bg-[#F8FAFC] text-[#030914] space-y-32 md:space-y-48 pb-36 font-telegraf">
      ...
      <section className="pt-32 md:pt-36 px-6 md:px-16">
        <GinkgoHeroCard
          ...
          primaryBtnText="Explore Quality Steps"
