    ...
    <footer className="bg-[#030914] text-white pt-24 pb-16 px-6 md:px-16 border-t border-white/15 font-architekt">
      <div className="max-w-[1800px] mx-auto space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start justify-between border-b border-white/15 pb-16">
          ...
          <div className="lg:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-8 text-xs uppercase tracking-wider">
            ...
            <div className="space-y-4">
              <div className="text-white font-bold border-b border-white/10 pb-2">Platforms</div>
              <ul className="space-y-2.5 text-slate-300">
                <li><Link to="/capabilities#extraction" className="hover:text-[#00D2FF] transition-colors">Botanical Extraction</Link></li>
            ...
            <div className="space-y-4">
              <div className="text-white font-bold border-b border-white/10 pb-2">Infrastructure</div>
              <ul className="space-y-2.5 text-slate-300">
                <li><Link to="/infrastructure" className="hover:text-[#00D2FF] transition-colors">Manufacturing Campus</Link></li>
                <li><Link to="/infrastructure#blueprint" className="hover:text-[#00D2FF] transition-colors">Facility Architecture</Link></li>
                ...
                <li><Link to="/contract-manufacturing" className="hover:text-[#00D2FF] transition-colors">CDMO Methodology</Link></li>
              </ul>
            </div>

            <div className="space-y-4">
              <div className="text-white font-bold border-b border-white/10 pb-2">Company</div>
              <ul className="space-y-2.5 text-slate-300">
                <li><Link to="/about" className="hover:text-[#00D2FF] transition-colors">Our Story</Link></li>
                <li><Link to="/research-development" className="hover:text-[#00D2FF] transition-colors">R&D Formulation</Link></li>
                <li><Link to="/partner" className="hover:text-[#00D2FF] transition-colors">Project Intake</Link></li>
        ...
        <div className="p-8 rounded-3xl bg-white/5 border border-white/10 text-xs text-slate-400 space-y-3 font-telegraf leading-relaxed">
          <div className="font-architekt text-[#00D2FF] font-bold tracking-widest uppercase">
